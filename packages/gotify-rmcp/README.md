...
**30-second path:** set `GOTIFY_URL`, then run `npx -y @dinglebear/rgotify-mcp health --json`
-> start loopback HTTP with `GOTIFY_MCP_HOST=127.0.0.1 npx -y @dinglebear/rgotify-mcp serve`
...
| Binary / CLI | `rgotify` |
| npm package | `@dinglebear/rgotify-mcp` |
...
|---|---|---|---|
| npm / npx | `npx -y @dinglebear/rgotify-mcp --help` | Local MCP clients and quick trials. | Downloads the matching `rgotify` binary from GitHub Releases. |
...
```bash
npx -y @dinglebear/rgotify-mcp --help
npx -y @dinglebear/rgotify-mcp mcp
npx -y @dinglebear/rgotify-mcp health --json
```
...
```bash
GOTIFY_MCP_HOST=127.0.0.1 npx -y @dinglebear/rgotify-mcp serve
```
...
|---|---:|---|---|
| MCP stdio | Supported | `rgotify mcp`, `npx -y @dinglebear/rgotify-mcp mcp` | Local child-process MCP clients. |
